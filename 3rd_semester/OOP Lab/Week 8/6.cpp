/*
 Wap to create Student class. Data member name,roll. 
 And Academic class derived from student and data member a1,a2 mark. 
 And sport class derived from Student and data member is s1,s2 mark. 
 And Result class derived from Academic & Sport, which will display 
 roll, name, a1, a2 mark and s1, s2 mark along with display total 
 mark using appropriate mark.
 */
#include<iostream>
using namespace std;
