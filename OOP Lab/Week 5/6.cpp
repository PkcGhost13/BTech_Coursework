/*
Wap to create a Telephone class. Which has two data 
member name and phno. And one function search. 
which will accept name and display person phono no 
and same function accept phono and retrurns name by 
...
int main(void)
{
    ...
    do
    {
        ...
        switch(choice)
        {
            case 1:
                int n;
                cout<<"How many entries do you wish to make:"<<endl;
                cin>>n;
